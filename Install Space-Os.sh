...
sudo apt-get install brave-browser partitionmanager timeshift filelight libreoffice okular dragonplayer elisa gthumb snapd git clamtk clamav konsole ark stacer moun transmission; # apt packages installation
