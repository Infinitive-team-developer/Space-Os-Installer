...
sudo apt-get install gufw brave-browser partitionmanager timeshift filelight libreoffice okular dragonplayer elisa gthumb snapd git clamtk clamav konsole ark stacer muon transmission; # apt packages installation
